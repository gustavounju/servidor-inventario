...
VALUES
  ('sitio_temporalmente_inactivo', 'false'),
  ('sitio_mensaje_inactivo', 'El sistema esta temporalmente inactivo por tareas de mantenimiento.'),
  ('sitio_usuario_acceso_emergencia', 'gmurad');
