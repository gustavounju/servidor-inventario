...
- **Feature (25 Junio 2026)**: Módulo de mensajería interna. Se implementó un nuevo botón `[ COMUNICAR ]` en el Visor de Tareas, exclusivo para el rol Administrador, que permite enviar notificaciones Push (vía Firebase Cloud Messaging) de forma individual a un técnico específico o a todos a la vez. Los mensajes personales son completamente privados y se omiten de la tabla global de notificaciones.
---
