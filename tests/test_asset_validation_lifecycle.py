...
def test_validation_hides_autogenerated_hardware_shadows_in_registered_column():
    telemetry = {
        "Sistema": {"Procesador": "Intel(R) Pentium(R) Gold G5420 CPU @ 3.80GHz", "RAM (GB)": 3.87},
        "Motherboard_Model": "Micro-Star International Co., Ltd. H310M PRO-VDH PLUS (MS-7C09) (SN: K3G0019853)",
        "Disk_Models": "KINGSTON SA400S37240G (224GB) [SN: 50026B7785247C4D]",
    }
    pc = {
        "processor": "Intel(R) Pentium(R) Gold G5420 CPU @ 3.80GHz",
        "motherboard_model": telemetry["Motherboard_Model"],
        "ram_gb": 3.87,
        "disk_models": telemetry["Disk_Models"],
        "telemetry_snapshot": json.dumps(telemetry),
        "full_json_data": None,
    }
        ...
        unified_components=[
            {
                ...
                "brand_model": "Micro-Star International Co., Ltd. H310M PRO-VDH PLUS (MS-7C09)",
                "serial_number": "INT-MOT-20260804-4871",
                "is_autogenerated_id": 1,
            },
            {
                "component_type": "Motherboard",
                "brand_model": "Micro-Star International Co., Ltd. H310M PRO-VDH PLUS (MS-7C09) (SN: K3G0019853)",
                "serial_number": "MS-7C09",
                "is_autogenerated_id": 0,
            },
            {
                "component_type": "Disco Rígido / SSD",
                "brand_model": "KINGSTON SA400S37240G (224GB)",
                "serial_number": "INT-DIS-20260804-6571",
                "is_autogenerated_id": 1,
            },
            {
                "component_type": "Disco Rígido / SSD",
                "brand_model": "KINGSTON SA400S37240G (224GB) [SN: 50026B7785247C4D]",
                "serial_number": "224GB",
                "is_autogenerated_id": 0,
            },
        ],
    ...
    motherboard_row = next(row for row in comparison if row["component"] == "Motherboard")
    disk_row = next(row for row in comparison if row["component"] == "Almacenamiento (Disco)")
    assert "INT-MOT" not in motherboard_row["registered"]
    assert "INT-DIS" not in disk_row["registered"]
    assert motherboard_row["registered"].count("Micro-Star International") == 1
    assert disk_row["registered"].count("KINGSTON SA400S37240G") == 1
