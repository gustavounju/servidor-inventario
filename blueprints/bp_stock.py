...
def add_component():
    try:
        ...
        with get_db_connection() as conn:
            ...
            status = 'Installed' if (assigned_user or assigned_fuero) else 'Stock'
            added_serials = []
    ...
    try:
        ...
        with get_db_connection() as conn:
            ...
            conn.execute(
                """
                UPDATE components
                SET status = %s, assigned_pc = %s, assigned_user = %s, assigned_fuero = %s, lifecycle_status = 'desplegado'
                WHERE serial_number = %s
                """,
            ...
            for serial in clean_serials:
                ...
                if comp:
                    ...
                    conn.execute(
                        """
                        UPDATE components
                        SET status = %s, assigned_pc = %s, assigned_user = %s, assigned_fuero = %s, kit_name = NULL, lifecycle_status = 'desplegado'
                        WHERE serial_number = %s
                        """,
                        (new_status, pc_name or None, assigned_user or None, assigned_fuero or None, serial)
                    )
