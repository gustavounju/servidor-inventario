                    ...
                    try:
                        conn.execute(
                            ...
                            INSERT INTO components (
                                ...
                                assigned_pc, assigned_user, assigned_fuero, supplier,
                                invoice_number, oc_number, is_autogenerated_id, created_at
                            ) VALUES (
                                %s, %s, %s, 'Asignado', 'asignado',
                                %s, %s, %s, 'Homologación Telemetría WMI',
                                NULL, NULL, %s, NOW()
                            )
                            """,
                            (sn, comp_type, brand_model_str, pc_name, assigned_user, assigned_fuero, is_auto)
                        )
